package com.arena.signaling.interceptor;
...
public class JwtChannelInterceptor implements ChannelInterceptor {
    ...
    @Autowired
    @Lazy
    public void setRoomManager(RoomManageService roomManageService) {
    ...
    public Message<?> preSend(Message<?> message, MessageChannel channel) {
        ...
        if (accessor != null && StompCommand.CONNECT.equals(accessor.getCommand())) {
            ...
            if(roomManageService.isUserInRoom(userEmail)) {
                log.warn("User already in room: {}", userEmail);
